...
const SingleJobDetails = () => {
  ...
  const handleToggleEndAndDeleteModal = (type) => {
    if (type === "endModal") {
      setShowEndJobModal(!showEndJobModal);
    } else {
  ...
  console.log(singleJobDescription?.status,"singleJobDescription?.status")
  ...
  const deletejob = (
    <Tooltip id="tooltip">
      {(singleJobDescription?.status == "Unpublished"||singleJobDescription?.status == "unpublished")
        ? "Delete Job"
                  ...
                  <>
                    <OverlayTrigger placement="top" overlay={endjob}>
                      <Button
                        ...
                        //       action: "openEndModal",
                        //       idToEnd: singleJobDescription?.id,
                        //     });
                        //   }
                        ...
                        <div className="interview-wrapper position-relative mb-3 pt-4">
                          <div>
                            ...
                            <div className="dev-name mb-2 font-14 d-flex align-items-center">
                              <div className="me-1">
                                <img
                                  src={item.developer.profile_picture}
                            ...
                            <div className="d-flex align-items-center gap-2">
                              {item.interview.status === "completed" && (
                                <>
                                  ...
                                  <Button
                                    onClick={() =>
                                      checkEventStatus(item.interview.id)
                                    }
                                    variant="transparent"
                                    className="outline-main-btn font-14"
                                  >
          ...
          <Tab eventKey="documentation" title={offered}>
            ...
            <div>
              <div className="text-end mb-4">
                <Button variant="transparent" className="font-14 main-btn">
                  Create Document
                </Button>
              </div>
                ...
                {!selectedDocument && (
                  <div>
                    ...
                    <p className="text-center mb-4">
                      Select document you want to create
                    </p>
                ...
                {selectedDocument && !documentOwner && (
                  <div id="document-ownership">
                    <h4 className="text-center">
                      Document Ownership: Client or Candidate?
                    </h4>
                    <p className="text-center mb-4">
                ...
                {isNewStepCompleted &&
                  ...
                  !documentSaved && (
                    <div id="select-candidates">
                      ...
                      <p className="text-center mb-4">
                        Please select candidate for non disclosure agreement.
