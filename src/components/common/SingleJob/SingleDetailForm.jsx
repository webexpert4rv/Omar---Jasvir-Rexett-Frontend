...
function SingleDetailForm({ handleBack, handleSave }) {
    ...
    return (
      <>
                                ...
                                <div>
                                    ...
                                    <div className="drag-listing">
                                        ...
                                        <div>
                                            ...
                                            <p className="mb-0">Date Signed</p>
                                        </div>
                                        <div>
                                            <div className="drag-icon">
                                                <IoTextSharp />
                                    ...
                                    <h4 className="mb-1 mt-3 d-flex justify-content-between align-items-center">
                                        Custom fields
                                        <span className="plus-btn cursor-pointer" onClick={handleCustomField}>+</span>
                                    </h4>
                                    <div className="drag-listing">
                                        <div>
                                            <div className="drag-icon">
                                            ...
                                            <p className="mb-0">Custom field</p>
                                        </div>
                                    </div>
                                </div>
        ...
        <CustomFieldModal show={showcustomfield} handleClose={handleCloseCustomField} />
      </>
    )
}
