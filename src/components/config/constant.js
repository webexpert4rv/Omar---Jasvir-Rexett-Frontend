...
export const ADMIN_SIDE_BAR_ITEMS= [
    ...
    { to: `/${permission_role_name}/job-listing`, icon: <FaListUl />, text: "jobListing",slug:"job-listing",active:true },
    // { to: "/admin/edit-admin-profile", icon: <IoIosSettings />, text: "editProfile" },
    { to: `/${permission_role_name}/documents`, icon: <IoDocuments />, text: "Documents/images", slug:"documents",active:true },
    { to: `/${permission_role_name}/time-reporting`, icon: <BsClockFill />, text:"timeReporting",slug:"time-reporting",active:true },
    // { to: "/admin/interviews", icon: <IoIosLaptop />, text:"Interviews" },
    { to: `/${permission_role_name}/invoice`, icon: <PiCoinsFill />, text: "Invoice",slug:"invoice",active:true },
