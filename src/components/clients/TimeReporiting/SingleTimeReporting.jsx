...
const SingleTimeReporting = ({currentDetails,selectedPeriod}) => {
    const [updateWeeklyData,setUpdateWeeklyData]=useState()
    let {contractDetails:{user_details},endDate,startDate,timeReports:{end_time,start_time,memo,weeklyDetails,monthlyDetails,report_date,week},totalDuration}=currentDetails
  ...
  <>
   {selectedPeriod=="weekly" ? <div className='detail-view day-view'>
    ...
    <div className='client-info mb-3 d-`flex gap-5'>
        <div className='mb-0'>
            <p className='client-name-heading d-flex gap-1 align-items-center mb-2'><FiCalendar />{report_date}</p>
        </div>
        <div className='d-flex gap-4 justify-content-between'>
            <div className='d-flex gap-3 align-items-center'>
                ...
                <p className='client-name-heading d-flex gap-1 align-items-center'><FaRegClock />{start_time? moment(end_time, 'HH:mm:ss').format('h:mm:ss A'):"00:00"}</p>
            </div>
        </div>
    </div>
...
{selectedPeriod=="monthly"? <div className='client-info mb-3 gap-5 d-flex align-items-center'>
    <div className='mb-0'>
        <p className='client-name-heading d-flex gap-1 align-items-center'><FiCalendar />{week} {report_date}</p>
    </div>
    <div className='d-flex gap-4 justify-content-between'>
        <div className='d-flex gap-3 align-items-center'>
            <p className='client-name-heading d-flex gap-1 align-items-center fw-semibold'><FaRegClock /> {totalDuration} hrs</p>
        </div>
    </div>
    <div>
...
{selectedPeriod=="yearly"? <div className='detail-view monthly-view'>
                        ...
                        <div className='client-info mb-3 gap-5 d-flex align-items-center'>
                            ...
                            <div className='d-flex gap-4 justify-content-between'>
                                <div className='d-flex gap-3 align-items-center'>
                                    <p className='client-name-heading d-flex gap-1 align-items-center fw-semibold'><FaRegClock /> {totalDuration.toFixed("2")} hrs</p>
                                </div>
                            </div>
                            <div>
                                <span className="status-progress">Progress</span>
                        ...
                        <Tab.Container id="left-tabs-example" defaultActiveKey="Week 1" onSelect={selectCurrentTab}>
                            <Nav variant="pills" className="weekly-tabs">
                                <Nav.Item className='weekly-tab-item'>
                                    <Nav.Link className='weekly-tab-link' eventKey="Week 1">Week 1</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className='weekly-tab-item'>
                                    <Nav.Link className='weekly-tab-link' eventKey="Week 2">Week 2</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className='weekly-tab-item'>
                                    <Nav.Link className='weekly-tab-link' eventKey="Week 3">Week 3</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className='weekly-tab-item'>
                                    <Nav.Link className='weekly-tab-link' eventKey="Week 4">Week 4</Nav.Link>
                                </Nav.Item>
                            </Nav>
                            <Tab.Content>
