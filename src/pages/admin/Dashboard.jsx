...
const AdminDashboard = () => {
  ...
  const { listOfClients, adminDashboard, screenLoader } = useSelector(
    ...
    datasets: [
      {
        label: "Total Revenue",
        data: [
          1000, 20000, 15000, 14000, 12500, 12300, 4000, 3000, 5000, 6000, 5500,
          12000,
        ],
        fill: false,
    ...
    datasets: [
      {
        label: "This Year",
        data: [
          5000, 20000, 15000, 22000, 18000, 25000, 20000, 10000, 15000, 20000,
          25000, 22000,
        ],
      ...
      },
      {
        label: "Last Year",
        data: [
          7000, 12000, 17000, 14000, 19000, 24000, 18000, 14000, 19000, 12000,
          18000, 14000,
        ],
        borderColor: "#c00",
    ...
    <>
      {screenLoader ? (
        ...
        <div>
          ...
          <div className="overview-card-wrapper mb-5">
            ...
            <div className="overview-card">
              <div>
                ...
                <h3 className="overview-card-heading mb-0">
                  {adminDashboard?.data?.numberOfClientsJoined}
                </h3>
              </div>
              <span className="over-icon">
                <IoTrendingUpSharp />
            ...
            <div className="overview-card">
              <div>
                ...
                <h3 className="overview-card-heading mb-0">
                  {adminDashboard?.data?.numberOfVendorsJoined}
                </h3>
              </div>
              <span className="over-icon">
                <IoTrendingUpSharp />
            ...
            <div className="overview-card">
              <div>
                ...
                <h3 className="overview-card-heading mb-0">
                  {adminDashboard?.data?.totalJobsPosted}
                </h3>
              </div>
              <span className="over-icon">
                <IoTrendingUpSharp />
            ...
            <div className="overview-card">
              <div>
                <h4 className="overview-card-subhead">
                  Total Developer Joined
                </h4>
                <h3 className="overview-card-heading mb-0">
                  {adminDashboard?.data?.numberOfDevelopersJoined}
                </h3>
              </div>
              <span className="over-icon">
                <IoTrendingUpSharp />
            ...
            <Row>
              <Col xxl={6} lg={12} className="mb-4">
                <div className="card-box h-100">
                  <h3 className="section-head pb-0 border-0 mb-4">
                    Total Revenue
                  </h3>
              ...
              <Col xxl={6} lg={12} className="mb-4">
                <div className="card-box">
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    <h3 className="section-head pb-0 border-0 mb-0">
                      Activity Logs
                    </h3>
                  </div>
                  <div className="">
                      ...
                      <table className="table table-ui-custom">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="time-table-data text-start font-14 fw-normal">
                              David Williams is shortlisted for figma ui job
                            </td>
                            <td className="time-table-data text-start font-14 fw-normal white-nowrap">
                              2 mins ago
                            </td>
                          ...
                          <tr>
                            ...
                            <td className="time-table-data text-start font-14 fw-normal">
                              John Doe wants to edit his profile
                            </td>
                            <td className="time-table-data text-start font-14 fw-normal white-nowrap">
                              3 mins ago
                            </td>
                          ...
                          <tr>
                            ...
                            <td className="time-table-data text-start font-14 fw-normal">
                              You have approved Smith application
                            </td>
                            <td className="time-table-data text-start font-14 fw-normal white-nowrap">
                              10 mins ago
                            </td>
                          ...
                          <tr>
                            ...
                            <td className="time-table-data text-start font-14 fw-normal">
                              Rohit's timesheet has been approved by Amazon for
                              AI Bot project
                            </td>
                            <td className="time-table-data text-start font-14 fw-normal white-nowrap">
                              10:30 AM
          ...
          <Row className="mb-5">
            <Col md={12}>
              ...
              <div className="developers-list">
                {adminDashboard?.data?.clients.length > 0 ? (
                  adminDashboard?.data?.clients.map((item, index) => {
                    return (
                      <>
                        <div
                          className="developer-card client-card"
                          onClick={() => handleClientCardClick(item?.id)}
                        >
                    ...
                    <Col md={6}>
                      <div className="status-card d-flex justify-content-between align-items-center">
                        ...
                        <div>
                          ...
                          <div>
                            <p className="status-text-card">
                              {adminDashboard?.data?.totalJobsPosted}{" "}
                              <span className="increase-text">+10</span>
                            </p>
                          </div>
                        </div>
                        <div>
                    ...
                    <Col md={6}>
                      <div className="status-card d-flex justify-content-between align-items-center">
                        ...
                        <div>
                          ...
                          <div>
                            <p className="status-text-card">
                              50 <span className="increase-text">+30</span>
                            </p>
                          </div>
                        </div>
                        <div>
                          <div className="graph-status">
                            <Line
                              ...
                              options={CompletedProjectOptions}
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="table-responsive activity-log-table ongoing-project-table">
                      <table className="table table-ui-custom">
                        ...
                        <tbody>
                          <tr>
                            <td className="time-table-data text-start font-14 fw-normal white-nowrap">
                              Need Full stack MERN developer
                            </td>
                            <td className="time-table-data text-start font-14 fw-normal">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="section-head-sub mb-0">
              {t("listOfAssignedDevelopers")}
            </h2>
            {adminDashboard?.data?.assignedDevelopers.length > 0 ? (
              <div className="text-center mt-3">
                <Link to={"/admin/developer-list"} className="link-text-dark">
                  {t("seeAll")}
                </Link>
              </div>
            ) : (
                ...
                return (
                  <>
                    <div
                      ...
                      onClick={() => handleCardClick(item?.developer_id)}
                    >
                      <div className="user-imgbx">
                        <img
                          src={
                      ...
                      <div className="text-center">
                        ...
                        <ul className="social-icons">
                          <li>
                            <Link
                              to={`${item?.developer?.developer_detail?.github_url}`}
                            >
                              <FaGithub />
                            </Link>
                          </li>
                          <li>
                            <Link
                              to={`${item?.developer?.developer_detail?.linkedin_url}`}
                            >
                              <FaLinkedin />
                            </Link>
                          </li>
