            ...
            <Tab.Container defaultActiveKey="revenue">
                <Nav variant="pills" className="weekly-tabs mb-4">
                    <Nav.Item className='weekly-tab-item'>
                        <Nav.Link className='weekly-tab-link d-flex align-items-center gap-2' eventKey="revenue">Revenue</Nav.Link>
                    </Nav.Item>
                    <Nav.Item className='weekly-tab-item'>
                            ...
                            <Tab.Container id="left-tabs-example" defaultActiveKey="raise-by-devs">
                                <div className="d-flex justify-content-center">
                                    <Nav variant="pills" className="weekly-tabs mb-0">
                                        <Nav.Item className='weekly-tab-item'>
                                            <Nav.Link className='weekly-tab-link d-flex align-items-center gap-2' eventKey="raise-by-devs">Raise By Devs</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item className='weekly-tab-item'>
                                            <Nav.Link className='weekly-tab-link' eventKey="raise-by-vendors">Raise By Vendors</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item className='weekly-tab-item'>
                                ...
                                <Tab.Content>
                                            ...
                                            <table className="table time-table table-bordered table-ui-custom">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="time-table-data text-start"><span className="status-progress">Progress</span></td>
                                                        <td className="time-table-data text-start"><Button className="main-btn px-3 py-1 font-14" disabled>Paid</Button></td>
                                                    </tr>
                                                    <tr>
                                                        <td className="time-table-data text-start">
                                                            <div className="d-flex align-items-center gap-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="time-table-data text-start"><span className="status-progress">Unpaid</span></td>
                                                        <td className="time-table-data text-start"><span className="status-finished">Completed</span></td>
                                                        <td className="time-table-data text-start"><Button className="main-btn px-3 py-1 font-14">Invoice Paid</Button></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <Tab.Pane eventKey="raise-by-vendors">
                                        <div className="filter-section d-lg-flex align-items-center mt-3 justify-content-between mb-3">
                                            <div className="d-flex align-items-center gap-2 flex-wrap">
                                                <div>
                                                    <Form.Select className="time-filter-select shadow-none">
                                            ...
                                            <table className="table time-table table-bordered table-ui-custom">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="time-table-data text-start"><span className="status-progress">Unpaid</span></td>
                                                        <td className="time-table-data text-start"><span className="status-finished">Completed</span></td>
                                                        <td className="time-table-data text-start"><Button className="main-btn px-3 py-1 font-14 white-nowrap" disabled>Invoice Raised</Button></td>
                                                    </tr>
                                                    <tr>
                                                        <td className="time-table-data text-start">
                                                            <div className="d-flex align-items-center gap-2">
