        ...
        <>
            <section>
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <Button variant="transparent" onClick={handleShowEditTimeModal}   className="main-btn px-5">Add Time Report</Button>
                    </div>
                </div>
                ...
                <AddTimingModal show={showEditTimeModal} handleClose={handleCloseEditTimeModal}/>  
