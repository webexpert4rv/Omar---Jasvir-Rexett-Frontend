    ...
    return(
        <Modal show={show} onHide={(e)=>handleClose(e)} centered animation className="custom-modal">
            ...
            <Modal.Body>
                ...
                <div className="text-center mt-4"> <RexettButton variant="transparent"  onClick = {handleClose} type = "submit" text = "Cancel" className="outline-main-btn font-14 fw-semibold bg-transparent border-black text-black px-4"/></div> 
            </Modal.Body>
        </Modal>
    )
}
