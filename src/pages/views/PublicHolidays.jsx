        ...
        <>
            <section className="">
                <div className="calendar-container card-box">
                    <div className="mb-3">
                        <Button className="main-btn px-3 py-2 font-14" onClick={handleShowEvent}>+ Create New Event</Button>
                    </div>
                    <Row>
                        <Col md={7}>
                                ...
                                <div className="event-container">
                                    <div className="event-wrapper">
                                        ...
                                        <div className="d-flex gap-2">
                                            <Button variant="transparent" className="px-3 arrow-btn primary-arrow font-16 text-decoration-none">
                                                <IoCheckmark />
                                            </Button>
                                            <Button variant="transparent" className="px-3 arrow-btn danger-arrow font-16 text-decoration-none">
                                                <IoCloseOutline />
                                            </Button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="event-wrapper">
                                        ...
                                        <div className="d-flex gap-2">
                                            <Button variant="transparent" className="px-3 arrow-btn info-arrow font-16 text-decoration-none">
                                                <TiEdit />
                                            </Button>
                                            <Button variant="transparent" className="px-3 arrow-btn danger-arrow font-16 text-decoration-none">
                                                <IoCloseOutline />
